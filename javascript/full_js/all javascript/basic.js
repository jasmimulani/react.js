...
// local storage
//  stringify -> convert to original typre
//  parse -> conver objet form

//  call back function-------------------
// any function that is passed as argument is called callback function

// ------------------------------ kathiyavadi method ------------------- but not right
  ...
  setTimeout(() => {
    ...
    setTimeout(
      (rollno) => {
        ...
        console.log(
          `my rollno ${rollno}my name is ${biodata.name} and i am ${biodata.age} years old`
        );
        ...
        setTimeout(
          (name) => {
            ...
            console.log(
              `my rollno ${rollno}my name is ${biodata.name} and i am ${biodata.age} years old and i am ${biodata.gender}`
            );
          },
          2000,
          biodata.name
